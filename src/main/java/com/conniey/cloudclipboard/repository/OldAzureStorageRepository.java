...
public class OldAzureStorageRepository implements ClipRepository {
    ...
    @Autowired
    public OldAzureStorageRepository(StorageConfiguration configuration, ObjectMapper objectMapper)
        ...
        this.containerClient = cloudBlobClient.getContainerReference(configuration.getContainerName());
    }
